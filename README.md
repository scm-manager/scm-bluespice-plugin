...
Integrates BlueSpice MediaWiki to SCM-Manager

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-bluespice-plugin/docs/).
